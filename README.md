...
- **Windows** — `wavelet-<version>-win-x64-setup.exe` (NSIS installer) or `wavelet-<version>-win-x64-portable.exe`
- **macOS** — `wavelet-<version>-mac-x64.dmg` / `wavelet-<version>-mac-arm64.dmg`
...
- **Windows** — `wavelet-<version>-win-x64-setup.exe`（NSIS 安装器）或 `wavelet-<version>-win-x64-portable.exe`
- **macOS** — `wavelet-<version>-mac-x64.dmg` / `wavelet-<version>-mac-arm64.dmg`
