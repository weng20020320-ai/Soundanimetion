...
if (stage === 'pre') {
  ...
  console.log('          wavelet-win-x64-portable.exe   绿色单文件，免安装');
  console.log('          wavelet-win-x64-setup.exe      NSIS 安装包');
  console.log();
  line(
    COLOR.dim,
  ...
  console.log('    wavelet-win-x64-portable.exe   双击即跑，不写注册表');
  console.log('    wavelet-win-x64-setup.exe      NSIS 安装版');
  console.log();
} else if (stage === 'fail') {
